...
public class BlockTerrainControl extends AbstractControl implements BitSerializable
{
	...
	public BlockBase getBlockInst( int x, int y, int z )
	{
		return getBlockInst( new Vector3Int( x, y, z ) );
	}
	
	public BlockBase getBlockInst( Vector3Int location )
	{
		try
		{
			...
			{
				return localBlockState.getBlock().getBlock();
			}
	...
	{
		return getBlockId( new Vector3Int( x, y, z ) );
	}
	...
	public byte getBlockId( Vector3Int location )
	{
