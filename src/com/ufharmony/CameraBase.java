...
public class CameraBase implements AnalogListener, ActionListener
{
	
	private static String[] mappings = new String[] { "FLYCAM_Left", "FLYCAM_Right", "FLYCAM_Up", "FLYCAM_Down",	"FLYCAM_StrafeLeft", "FLYCAM_StrafeRight",
	"FLYCAM_Forward", "FLYCAM_Backward", "FLYCAM_ZoomIn", "FLYCAM_ZoomOut", "FLYCAM_RotateDrag", "FLYCAM_Rise", "FLYCAM_Lower", "FLYCAM_InvertY" };
	...
	/**
	 * Gets the zoom speed. The speed is a multiplier to increase/decrease the zoom rate.
	 * 
	 * @return zoomSpeed
	 */
	...
	/**
	 * @return If enabled
	 * @see CameraBase#setEnabled(boolean)
	 */
	 ...
	 * 
	 * @see CameraBase#setDragToRotate(boolean)
	 */
	 ...
	 * 
	 * When true, the user must hold the mouse button and drag over the screen to rotate the camera, and the cursor is
	 * visible until dragged. Otherwise, the cursor is invisible at all times and holding the mouse button is not needed
