...
public class TerrainHelper
{
	...
	public static CubesSettings getSettings( Application application )
	{
		...
		settings.setDefaultBlockMaterial( "Textures/set1.png" );
		
		settings.setChunkSizeX( 16 );
		settings.setChunkSizeY( 256 );
		settings.setChunkSizeZ( 16 );
		settings.setBlockSize( 1.5f );
	...
	public static void doExplosion( int explosionX, int explosionY, int explosionZ )
	{
		...
		List<ChunkPosition> affectedBlockPositions = new ArrayList<ChunkPosition>();
				...
				for ( var5 = 0; var5 < field_77289_h; ++var5 )
				{
					if ( var3 == 0 || var3 == field_77289_h - 1 || var4 == 0 || var4 == field_77289_h - 1 || var5 == 0 || var5 == field_77289_h - 1 )
					{
						...
						for ( float var21 = 0.3F; var14 > 0.0F; var14 -= var21 * 0.75F )
						{
							...
							BlockBase var26 = Main.getWorld().getBlockInst( var22, var23, var24 );
		...
		for ( ChunkPosition cp : affectedBlockPositions )
		{
			var4 = cp.x;
			var5 = cp.y;
			var6 = cp.z;
			BlockBase var25 = Main.getWorld().getBlockInst( var4, var5, var6 );
			
			if ( var25 != null )
			{
				Main.getWorld().removeBlock( var4, var5, var6 );
				var25.onBlockDestroyedByExplosion();
			}
		}
	}
